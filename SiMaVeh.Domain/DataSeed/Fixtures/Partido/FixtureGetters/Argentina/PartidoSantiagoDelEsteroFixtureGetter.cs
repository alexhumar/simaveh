...
{
    class PartidoSantiagoDelEsteroFixtureGetter : PartidoFixtureGetter
    {
        public PartidoSantiagoDelEsteroFixtureGetter(IProvinciaFixtureGetter provinciaFixtureGetter)
