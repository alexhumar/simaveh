...
{
    class LocalidadesChubutLoader : LocalidadFixtureGetter
    {
        public LocalidadesChubutLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Biedma).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Cushamen).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Escalante).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.FlorentinoAmeghino).Key, new Dictionary<long, string>
            {
                { 1237, LocalidadChubut.Camarones },
                { 1238, LocalidadChubut.Garayalde }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Futaleufu).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Gaiman).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Gastre).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Languineo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Martires).Key, new Dictionary<long, string>
            {
                { 1259, LocalidadChubut.LasPlumas },
                { 1260, LocalidadChubut.ElMirasol }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.PasoDeIndios).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Rawson).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.RioSenguer).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Sarmiento).Key, new Dictionary<long, string>
            {
                { 1277, LocalidadChubut.BuenPasto },
                { 1278, LocalidadChubut.Sarmiento }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Tehuelches).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoChubut.Telsen).Key, new Dictionary<long, string>
            {
