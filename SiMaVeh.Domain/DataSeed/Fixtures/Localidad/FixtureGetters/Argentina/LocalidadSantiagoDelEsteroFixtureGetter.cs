...
{
    class LocalidadSantiagoDelEsteroFixtureGetter : LocalidadFixtureGetter
    {
        public LocalidadSantiagoDelEsteroFixtureGetter(IPartidoFixtureGetter partidoFixtureGetter)
