...
{
    class LocalidadesLaRiojaLoader : LocalidadFixtureGetter
    {
        public LocalidadesLaRiojaLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Arauco).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Capital).Key, new Dictionary<long, string>
            {
                { 2369, LocalidadLaRioja.LaRioja }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.CastroBarros).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Chamical).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Chilecito).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.CoronelFelipeVarela).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Famatina).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.GeneralAngelVPenaloza).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.GeneralBelgrano).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.GeneralJuanFacundoQuiroga).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.GeneralLamadrid).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.GeneralOcampo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.GeneralSanMartin).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Independencia).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.RosarioVeraPenaloza).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.SanBlasDeLosSauces).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Sanagasta).Key, new Dictionary<long, string>
            {
                { 2534, LocalidadLaRioja.VillaSanagasta },
                { 2535, LocalidadLaRioja.AltaGracia },
                { 2536, LocalidadLaRioja.Huaco }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaRioja.Vinchina).Key, new Dictionary<long, string>
            {
