...
{
    class LocalidadesFormosaLoader : LocalidadFixtureGetter
    {
        public LocalidadesFormosaLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Bermejo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Formosa).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Laishi).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Matacos).Key, new Dictionary<long, string>
            {
                { 2101, LocalidadFormosa.IngenieroJuarez }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Patino).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Pilagas).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Pilcomayo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.Pirane).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoFormosa.RamonLista).Key, new Dictionary<long, string>
            {
