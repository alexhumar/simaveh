...
{
    class LocalidadesRioNegroLoader : LocalidadFixtureGetter
    {
        public LocalidadesRioNegroLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.AdolfoAlsina).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.Avellaneda).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.Bariloche).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.Conesa).Key, new Dictionary<long, string>
            {
                { 2949, LocalidadRioNegro.GeneralConesa }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.ElCuy).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.GeneralRoca).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.NueveDeJulio).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.Norquinco).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.PichiMahuida).Key, new Dictionary<long, string>
            {
                { 3000, LocalidadRioNegro.ColoniaJuliaYEcharren },
                { 3001, LocalidadRioNegro.RioColorado }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.Pilcaniyeu).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.SanAntonio).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.Valcheta).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoRioNegro.VeinticincoDeMayo).Key, new Dictionary<long, string>
            {
