...
{
    class LocalidadesTucumanLoader : LocalidadFixtureGetter
    {
        public LocalidadesTucumanLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Burruyacu).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Capital).Key, new Dictionary<long, string>
            {
                { 4177, LocalidadTucuman.SanMiguelDeTucuman }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Chicligasta).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.CruzAlta).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Famailla).Key, new Dictionary<long, string>
            {
                { 4199, LocalidadTucuman.Famailla }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Graneros).Key, new Dictionary<long, string>
            {
                { 4200, LocalidadTucuman.Graneros },
                { 4201, LocalidadTucuman.Lamadrid },
                { 4202, LocalidadTucuman.TacoRalo }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.JuanBautistaAlberdi).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.LaCocha).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Leales).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Lules).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Monteros).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.RioChico).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Simoca).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.TafiDelValle).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.TafiViejo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.Trancas).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoTucuman.YerbaBuena).Key, new Dictionary<long, string>
            {
