...
{
    class LocalidadTierraDelFuegoFixtureGetter : LocalidadFixtureGetter
    {
        public LocalidadTierraDelFuegoFixtureGetter(IPartidoFixtureGetter partidoFixtureGetter)
