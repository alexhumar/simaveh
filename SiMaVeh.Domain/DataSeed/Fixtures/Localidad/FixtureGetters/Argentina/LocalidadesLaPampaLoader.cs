...
{
    class LocalidadesLaPampaLoader : LocalidadFixtureGetter
    {
        public LocalidadesLaPampaLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Atreuco).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.CaleuCaleu).Key, new Dictionary<long, string>
            {
                { 2265, LocalidadLaPampa.LaAdela }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Capital).Key, new Dictionary<long, string>
            {
                { 2266, LocalidadLaPampa.Anguil },
                { 2267, LocalidadLaPampa.SantaRosa }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Catrilo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Chalileo).Key, new Dictionary<long, string>
            {
                { 2272, LocalidadLaPampa.SantaIsabel },
                { 2273, LocalidadLaPampa.Victorica }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Chapaleufu).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.ChicalCo).Key, new Dictionary<long, string>
            {
                { 2280, LocalidadLaPampa.AlgarroboDelAguila },
                { 2281, LocalidadLaPampa.LaHumada }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Conhelo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Curaco).Key, new Dictionary<long, string>
            {
                { 2288, LocalidadLaPampa.Puelches },
                { 2289, LocalidadLaPampa.VeinticincoDeMayo },
                { 2290, LocalidadLaPampa.GobernadorDuval }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Guatrache).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Hucal).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.LihuelCalel).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.LimayMahuida).Key, new Dictionary<long, string>
            {
                { 2309, LocalidadLaPampa.LaReforma },
                { 2310, LocalidadLaPampa.LimayMahuida }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Loventue).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Maraco).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Puelen).Key, new Dictionary<long, string>
            {
                { 2322, LocalidadLaPampa.Puelen },
                { 2323, LocalidadLaPampa.VeinticincoDeMayo },
                { 2324, LocalidadLaPampa.CasaDePiedra }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.QuemuQuemu).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Rancul).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Realico).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Toay).Key, new Dictionary<long, string>
            {
                { 2343, LocalidadLaPampa.Toay }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Trenel).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoLaPampa.Utracan).Key, new Dictionary<long, string>
            {
