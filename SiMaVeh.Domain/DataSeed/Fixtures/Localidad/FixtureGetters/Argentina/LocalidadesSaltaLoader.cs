...
{
    class LocalidadesSaltaLoader : LocalidadFixtureGetter
    {
        public LocalidadesSaltaLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Anta).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Cachi).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Cafayate).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Capital).Key, new Dictionary<long, string>
            {
                { 3076, LocalidadSalta.Salta }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Cerrillos).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Chicoana).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.GeneralGuemes).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.GeneralJoseDeSanMartin).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Guachipas).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Iruya).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.LaCaldera).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.LaCandelaria).Key, new Dictionary<long, string>
            {
                { 3153, LocalidadSalta.ElJardin },
                { 3154, LocalidadSalta.ElTala },
                { 3155, LocalidadSalta.LaCandelaria }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.LaPoma).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.LaVina).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.LosAndes).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Metan).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Molinos).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Oran).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.Rivadavia).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.RosarioDeLaFrontera).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.RosarioDeLerma).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.SanCarlos).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSalta.SantaVictoria).Key, new Dictionary<long, string>
            {
