...
{
    class LocalidadesSanJuanLoader : LocalidadFixtureGetter
    {
        public LocalidadesSanJuanLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Albardon).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Angaco).Key, new Dictionary<long, string>
            {
                { 3267, LocalidadSanJuan.VillaDelSalvador },
                { 3268, LocalidadSanJuan.VillaSefairTalacasto },
                { 3269, LocalidadSanJuan.LasTapias }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Calingasta).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Capital).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Caucete).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Chimbas).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Iglesia).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Jachal).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.NueveDeJulio).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Pocito).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Rawson).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Rivadavia).Key, new Dictionary<long, string>
            {
                { 3334, LocalidadSanJuan.Rivadavia },
                { 3335, LocalidadSanJuan.Marquesado },
                { 3336, LocalidadSanJuan.LaBebida }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.SanMartin).Key, new Dictionary<long, string>
            {
                { 3337, LocalidadSanJuan.SanIsidro },
                { 3338, LocalidadSanJuan.DosAcequias },
                { 3339, LocalidadSanJuan.LaPuntilla }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.SantaLucia).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Sarmiento).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Ullum).Key, new Dictionary<long, string>
            {
                { 3357, LocalidadSanJuan.VillaAurora },
                { 3358, LocalidadSanJuan.VillaIbanez },
                { 3359, LocalidadSanJuan.ElChilote }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.ValleFertil).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.VeinticincoDeMayo).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSanJuan.Zonda).Key, new Dictionary<long, string>
            {
