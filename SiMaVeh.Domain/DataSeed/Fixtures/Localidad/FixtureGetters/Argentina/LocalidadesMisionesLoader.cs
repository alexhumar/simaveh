...
{
    class LocalidadesMisionesLoader : LocalidadFixtureGetter
    {
        public LocalidadesMisionesLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Apostoles).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Cainguas).Key, new Dictionary<long, string>
            {
                { 2759, LocalidadMisiones.AristobuloDelValle },
                { 2760, LocalidadMisiones.DosDeMayo },
                { 2761, LocalidadMisiones.CampoGrande }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Candelaria).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Capital).Key, new Dictionary<long, string>
            {
                { 2769, LocalidadMisiones.Posadas },
                { 2770, LocalidadMisiones.Garupa },
                { 2771, LocalidadMisiones.Fachinal }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Concepcion).Key, new Dictionary<long, string>
            {
                { 2772, LocalidadMisiones.ConcepcionDeLaSierra },
                { 2773, LocalidadMisiones.SantaMaria }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Eldorado).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.GeneralManuelBelgrano).Key, new Dictionary<long, string>
            {
                { 2779, LocalidadMisiones.BernardoDeIrigoyen },
                { 2780, LocalidadMisiones.ComandanteAndresito },
                { 2781, LocalidadMisiones.SanAntonio }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Guarani).Key, new Dictionary<long, string>
            {
                { 2782, LocalidadMisiones.ElSoberbio },
                { 2783, LocalidadMisiones.SanVicente }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Iguazu).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.LeandroNAlem).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.LibertadorGeneralSanMartin).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Montecarlo).Key, new Dictionary<long, string>
            {
                { 2802, LocalidadMisiones.Caraguatay },
                { 2803, LocalidadMisiones.Montecarlo },
                { 2804, LocalidadMisiones.PuertoPiray }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.Obera).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.SanIgnacio).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.SanJavier).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.SanPedro).Key, new Dictionary<long, string>
            {
                { 2826, LocalidadMisiones.SanPedro }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoMisiones.VeinticincoDeMayo).Key, new Dictionary<long, string>
            {
