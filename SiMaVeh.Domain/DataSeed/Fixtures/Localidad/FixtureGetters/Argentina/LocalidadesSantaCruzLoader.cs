...
{
    class LocalidadesSantaCruzLoader : LocalidadFixtureGetter
    {
        public LocalidadesSantaCruzLoader(IPartidoFixtureGetter partidosLoader)
            : base(partidosLoader)
        {
        }
        ...
        {
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.CorpenAike).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.Deseado).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.GuerAike).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.LagoArgentino).Key, new Dictionary<long, string>
            {
            ...
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.LagoBuenosAires).Key, new Dictionary<long, string>
            {
                { 3465, LocalidadSantaCruz.LosAntiguos },
                { 3466, LocalidadSantaCruz.PeritoMoreno }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.Magallanes).Key, new Dictionary<long, string>
            {
                { 3467, LocalidadSantaCruz.PuertoSanJulian },
                { 3468, LocalidadSantaCruz.ElSalado },
                { 3469, LocalidadSantaCruz.BellaVista }
            });
            localidades.Add(partidoFixtureGetter.FindByNombre(PartidoSantaCruz.RioChico).Key, new Dictionary<long, string>
            {
