...
namespace SiMaVeh.DataAccess.Model.Interfaces
{
    ...
    public interface IRelatedEntityRemover
    {
        ...
        /// <returns></returns>
        Task<bool> TryRemoveRelatedEntityAsync<TTargetBe, TTargetBeId, TRelatedBe, TRelatedBeId>(TTargetBeId targetBeKey, TRelatedBeId relatedBeKey)
        ...
        /// <param name="targetBeKey"></param>
        /// <returns></returns>
        Task<bool> TryRemoveRelatedEntityAsync<TTargetBe, TTargetBeId, TRelatedBe, TRelatedBeId>(TTargetBeId targetBeKey)
